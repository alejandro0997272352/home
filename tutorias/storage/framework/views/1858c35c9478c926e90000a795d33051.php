<?php $__env->startSection('title', 'Importar Materias'); ?>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
        ...
        <form method="POST" action="<?php echo e(route('admin.materias.import')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/alejandro/home/tutorias/resources/views/admin/materias/import.blade.php ENDPATH**/ ?>