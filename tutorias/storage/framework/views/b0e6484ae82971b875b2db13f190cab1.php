...
<div class="card-hover glass-card rounded-xl shadow-md p-4 mb-6">
    <form method="GET" class="flex flex-wrap gap-4 items-end">
        <div>
            ...
            <input type="date" name="fecha_inicio" value="<?php echo e($startDate); ?>"
        ...
        <div>
            ...
            <input type="date" name="fecha_fin" value="<?php echo e($endDate); ?>"
                class="px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 transition-all">
        </div>
        ...
        <a href="<?php echo e(route('admin.reportes.pdf', ['fecha_inicio' => $startDate, 'fecha_fin' => $endDate])); ?>" class="btn-ripple px-4 py-2.5 bg-gradient-to-r from-red-600 to-rose-600 text-white rounded-xl hover:from-red-700 hover:to-rose-700 transition-all shadow-md">
...
<div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
    ...
    <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card-hover glass-card rounded-xl shadow-md p-4 text-center">
            <p class="text-2xl font-bold text-<?php echo e($s['color']); ?>-600 count-up" data-target="<?php echo e($s['value']); ?>">0</p>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1"><?php echo e($s['label']); ?></p>
        </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    <div class="card-hover glass-card rounded-xl shadow-md p-6">
        ...
        <div class="space-y-2">
            <?php $__currentLoopData = $citasPorTutor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex justify-between items-center p-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 dark:bg-gray-800/50 rounded-xl transition-all">
                    <span class="font-medium text-gray-800 dark:text-gray-200"><?php echo e($item->tutor->name ?? 'N/A'); ?></span>
                    <span class="bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 px-3 py-1 rounded-full text-sm font-medium"><?php echo e($item->total); ?> citas</span>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if($citasPorTutor->isEmpty()): ?>
    ...
    <div class="card-hover glass-card rounded-xl shadow-md p-6">
        ...
        <div class="space-y-2">
            <?php $__currentLoopData = $citasPorMateria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex justify-between items-center p-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 dark:bg-gray-800/50 rounded-xl transition-all">
                    <span class="font-medium text-gray-800 dark:text-gray-200"><?php echo e($item->subject->nombre ?? 'N/A'); ?></span>
                    <span class="bg-purple-100 dark:bg-purple-900/50 text-purple-700 px-3 py-1 rounded-full text-sm font-medium"><?php echo e($item->total); ?> citas</span>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if($citasPorMateria->isEmpty()): ?>
                <p class="text-gray-500 dark:text-gray-400 text-center py-4">Sin datos</p>
            <?php endif; ?>
        </div>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                <?php $__currentLoopData = $citas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 dark:bg-gray-800/50 transition-colors duration-150 table-row-glow animate-fade-in stagger-<?php echo e(min($loop->index + 1, 10)); ?>">
                        <td class="px-4 py-3 text-sm"><?php echo e($cita->fecha->format('d/m/Y')); ?> <?php echo e(substr($cita->hora_inicio, 0, 5)); ?></td>
                        <td class="px-4 py-3 text-sm font-medium"><?php echo e($cita->tutor->name); ?></td>
                        <td class="px-4 py-3 text-sm"><?php echo e($cita->student->name); ?></td>
                        <td class="px-4 py-3 text-sm"><?php echo e($cita->subject->nombre); ?></td>
                        ...
                        <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-400 max-w-xs">
                            <?php if($cita->estado === 'cancelada' && $cita->motivo_cancelacion): ?>
                                <span class="text-red-600 dark:text-red-400 flex items-center gap-1">
                                    <i class="fas fa-comment text-xs"></i>
                                    <?php echo e($cita->motivo_cancelacion); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/alejandro/home/tutorias/resources/views/admin/reportes/index.blade.php ENDPATH**/ ?>