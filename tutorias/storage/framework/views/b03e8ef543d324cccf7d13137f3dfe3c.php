...
<body style="font-family:sans-serif;padding:20px;">
    ...
    <table style="border-collapse:collapse;width:100%;max-width:400px;">
        <tr><td style="padding:6px;color:#666;">Tutor:</td><td style="padding:6px;"><strong><?php echo e($cita->tutor->name); ?></strong></td></tr>
    ...
    <?php if($cita->motivo_cancelacion): ?>
        <p style="margin-top:10px;padding:10px;background:#fee2e2;border-radius:5px;color:#991b1b;">
            <strong>Motivo:</strong> <?php echo e($cita->motivo_cancelacion); ?>
...
<?php /**PATH /home/alejandro/home/tutorias/resources/views/emails/cita-cancelada.blade.php ENDPATH**/ ?>