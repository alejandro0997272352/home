...
<div class="mb-6">
    <h1 class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
        <i class="fas fa-user-edit mr-2 text-indigo-600"></i>Editar Usuario: <?php echo e($user->name); ?>

    </h1>
</div>

<form method="POST" action="<?php echo e(route('admin.usuarios.update', $user)); ?>" enctype="multipart/form-data">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <?php if($user->foto_perfil): ?>
                            <p class="text-xs text-gray-500 mt-1">
                                <img src="<?php echo e($user->foto_url); ?>" class="w-10 h-10 rounded-full object-cover inline mr-1">
                                <?php echo e(basename($user->foto_perfil)); ?>
                    ...
                    <div>
                        ...
                        <select name="role" required
                            class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 transition-all">
                            <option value="estudiante" <?php echo e(old('role', $user->role) === 'estudiante' ? 'selected' : ''); ?>>Estudiante</option>
                            <option value="tutor" <?php echo e(old('role', $user->role) === 'tutor' ? 'selected' : ''); ?>>Tutor</option>
                            <option value="admin" <?php echo e(old('role', $user->role) === 'admin' ? 'selected' : ''); ?>>Administrador</option>
                        </select>
                    </div>
                    <div>
                        <label class="flex items-center cursor-pointer group">
                            <input type="checkbox" name="activo" value="1" <?php echo e(old('activo', $user->activo) ? 'checked' : ''); ?>
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                        <?php $__currentLoopData = $materias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $materia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-center gap-2 p-3 border border-gray-200 dark:border-gray-600 rounded-xl cursor-pointer hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-all has-[:checked]:border-indigo-500 has-[:checked]:bg-indigo-50 dark:has-[:checked]:bg-indigo-900/30">
                                <input type="checkbox" name="subjects[]" value="<?php echo e($materia->id); ?>"
                                    <?php echo e(in_array($materia->id, $user->subjects->pluck('id')->toArray()) ? 'checked' : ''); ?>

                                    class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                <span class="text-sm text-gray-700 dark:text-gray-300"><?php echo e($materia->nombre); ?></span>
                            </label>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                    ...
                    <div id="availabilityContainer" class="space-y-3">
                        <?php $__empty_1 = true; $__currentLoopData = $user->availability->where('activo', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="availability-row flex flex-wrap items-end gap-3 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                                <input type="hidden" name="availability[<?php echo e($loop->index); ?>][id]" value="<?php echo e($slot->id); ?>">
                                <div class="flex-1 min-w-[120px]">
                                    <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Día</label>
                                    <select name="availability[<?php echo e($loop->index); ?>][dia_semana]"
                                        ...
                                        <?php $__currentLoopData = ['Lunes','Martes','Miércoles','Jueves','Viernes','Sábado','Domingo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($dia); ?>" <?php echo e($slot->dia_semana === $dia ? 'selected' : ''); ?>><?php echo e($dia); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div>
                                    <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Inicio</label>
                                    <input type="time" name="availability[<?php echo e($loop->index); ?>][hora_inicio]" value="<?php echo e(substr($slot->hora_inicio, 0, 5)); ?>"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 transition-all text-sm">
                                </div>
                                <div>
                                    <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Fin</label>
                                    <input type="time" name="availability[<?php echo e($loop->index); ?>][hora_fin]" value="<?php echo e(substr($slot->hora_fin, 0, 5)); ?>"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 transition-all text-sm">
                                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div class="bg-blue-50 dark:bg-blue-900/30 rounded-xl p-4 text-center">
                            <p class="text-2xl font-bold text-blue-600"><?php echo e($user->tutorProfile->total_sesiones ?? 0); ?></p>
                        ...
                        <div class="bg-yellow-50 dark:bg-yellow-900/30 rounded-xl p-4 text-center">
                            <p class="text-2xl font-bold text-yellow-600"><?php echo e(number_format($user->tutorProfile->calificacion_promedio ?? 0, 1)); ?></p>
                        ...
                        <div class="bg-purple-50 dark:bg-purple-900/30 rounded-xl p-4 text-center">
                            <p class="text-2xl font-bold text-purple-600"><?php echo e($user->subjects->count()); ?></p>
                        ...
                        <div class="bg-green-50 dark:bg-green-900/30 rounded-xl p-4 text-center">
                            <p class="text-2xl font-bold text-green-600"><?php echo e($user->availability->where('activo', true)->count()); ?></p>
    ...
    <div class="flex justify-end space-x-3 mt-6">
        <a href="<?php echo e(route('admin.usuarios.index')); ?>" class="px-6 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-all">Cancelar</a>
...
<script>
let availIndex = <?php echo e($user->availability->where('activo', true)->count()); ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/alejandro/home/tutorias/resources/views/admin/usuarios/edit.blade.php ENDPATH**/ ?>