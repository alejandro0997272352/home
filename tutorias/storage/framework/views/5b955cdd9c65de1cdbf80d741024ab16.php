...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Tutorías Académicas'); ?> - <?php echo e(config('app.name')); ?></title>
...
<body class="bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 min-h-screen transition-colors duration-200 animate-fade-in">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center space-x-3 group">
                            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="h-9 w-9 rounded-full object-cover group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div class="ml-10 flex items-center space-x-1">
                            <?php if($role === 'admin'): ?>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.dashboard') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-chart-pie mr-1"></i>Dashboard
                                </a>
                                <a href="<?php echo e(route('admin.usuarios.index')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.usuarios.*') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-users mr-1"></i>Usuarios
                                </a>
                                <a href="<?php echo e(route('admin.materias.index')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.materias.*') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-book mr-1"></i>Materias
                                </a>
                                <a href="<?php echo e(route('admin.reportes')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.reportes') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-file-alt mr-1"></i>Reportes
                                </a>
                                <a href="<?php echo e(route('admin.actividad')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.actividad') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-history mr-1"></i>Actividad
                                </a>
                                <a href="<?php echo e(route('admin.db')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.db') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-database mr-1"></i>BD
                                </a>
                            <?php elseif($role === 'tutor'): ?>
                                <a href="<?php echo e(route('tutor.dashboard')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('tutor.dashboard') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-chart-pie mr-1"></i>Dashboard
                                </a>
                                <a href="<?php echo e(route('tutor.disponibilidad')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('tutor.disponibilidad') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-clock mr-1"></i>Disponibilidad
                                </a>
                                <a href="<?php echo e(route('tutor.citas')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('tutor.citas') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-calendar-check mr-1"></i>Mis Citas
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('estudiante.dashboard')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('estudiante.dashboard') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-chart-pie mr-1"></i>Dashboard
                                </a>
                                <a href="<?php echo e(route('estudiante.buscar')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('estudiante.buscar') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-search mr-1"></i>Buscar Tutores
                                </a>
                                <a href="<?php echo e(route('estudiante.citas')); ?>" class="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('estudiante.citas') ? 'text-white bg-indigo-600 shadow-md' : 'text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30'); ?>">
                                    <i class="fas fa-calendar-check mr-1"></i>Mis Citas
                                </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="relative" x-data="{ open: false, count: 0, notifs: [], shake: false }"
                            ...
                            <div x-show="open" @click.outside="open = false"
                                ...
                                <div class="p-3 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                                    ...
                                    <a href="<?php echo e(route('notificaciones.index')); ?>" class="text-xs text-indigo-600 hover:text-indigo-800 transition-colors">Ver todas</a>
                                </div>
                                <div class="max-h-80 overflow-y-auto">
                                    <template x-for="notif in notifs" :key="notif.id">
                                        <a :href="'<?php echo e(url('notificaciones')); ?>/' + notif.id + '/read'" class="flex items-start gap-3 p-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors border-b border-gray-50 dark:border-gray-700/50 last:border-0">
                        ...
                        <a href="<?php echo e(route('perfil')); ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors flex items-center gap-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 p-2 group">
                            <?php if(auth()->user()->foto_perfil): ?>
                                <img src="<?php echo e(auth()->user()->foto_url); ?>" alt="Foto" class="profile-photo w-7 h-7 rounded-full object-cover ring-2 ring-indigo-200 dark:ring-indigo-800">
                            <?php else: ?>
                            ...
                            <span class="ml-2 px-2 py-0.5 text-xs rounded-full font-medium
                                <?php if(auth()->user()->role === 'admin'): ?> bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-300
                                <?php elseif(auth()->user()->role === 'tutor'): ?> bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-300
    ...
    <main class="py-6">
        <div class="max-w-7xl mx-auto px-4">
            <?php if(session('success')): ?>
                <div class="toast-data hidden" data-type="success" data-message="<?php echo e(session('success')); ?>"></div>
            <?php endif; ?>
            <?php if(session('error')): ?>
                <div class="toast-data hidden" data-type="error" data-message="<?php echo e(session('error')); ?>"></div>
            <?php endif; ?>
            <?php if(session('info')): ?>
                <div class="toast-data hidden" data-type="info" data-message="<?php echo e(session('info')); ?>"></div>
            <?php endif; ?>
    ...
    <script>
        function fetchNotifs() {
            fetch('<?php echo e(route("notificaciones.unread")); ?>')
                .then(r => r.json())
                .then(d => {
...
<?php /**PATH /home/alejandro/home/tutorias/resources/views/layouts/app.blade.php ENDPATH**/ ?>