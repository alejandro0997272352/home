...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    ...
    <div class="flex gap-3">
        <a href="<?php echo e(route('admin.materias.import')); ?>" class="btn-ripple inline-flex items-center px-4 py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5">
            <i class="fas fa-file-import mr-2"></i>Importar
        </a>
        <a href="<?php echo e(route('admin.materias.create')); ?>" class="btn-ripple inline-flex items-center px-4 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5">
    ...
    <div class="p-4 border-b border-gray-100 dark:border-gray-700">
        <form method="GET" class="flex flex-wrap gap-4">
            <div class="flex-1 min-w-[200px]">
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Buscar por nombre o código..."
            ...
            <div>
                <select name="area" class="px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all">
                    ...
                    <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $areaOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($areaOption); ?>" <?php echo e(request('area') === $areaOption ? 'selected' : ''); ?>><?php echo e($areaOption); ?></option>
...
<div class="card-hover glass-card rounded-xl shadow-md overflow-hidden">
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                <?php $__currentLoopData = $materias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $materia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-indigo-50/50 dark:hover:bg-indigo-900/20 transition-colors duration-150 table-row-glow animate-fade-in stagger-<?php echo e(min($loop->index + 1, 10)); ?>">
                        <td class="px-6 py-4 text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($materia->codigo ?? '—'); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100"><?php echo e($materia->nombre); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400"><?php echo e($materia->area ?? '—'); ?></td>
                        <td class="px-6 py-4 text-sm text-center">
                            <span class="bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 px-2.5 py-1 rounded-full text-xs font-medium"><?php echo e($materia->creditos ?? '—'); ?></span>
                        </td>
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="<?php echo e(route('admin.materias.edit', $materia)); ?>" class="text-yellow-600 hover:text-yellow-900 mr-3 hover:scale-110 inline-block transition-transform">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form method="POST" action="<?php echo e(route('admin.materias.destroy', $materia)); ?>" class="inline" onsubmit="return confirm('¿Eliminar esta materia?')">
    ...
    <?php endif; ?>
    <div class="px-6 py-4 border-t border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/30"><?php echo e($materias->links()); ?></div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/alejandro/home/tutorias/resources/views/admin/materias/index.blade.php ENDPATH**/ ?>